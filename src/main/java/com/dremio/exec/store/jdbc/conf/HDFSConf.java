...
@SourceType(value = "HDFSARP", label = "HDFS",uiConfig = "hdfs-layout.json")
public class HDFSConf extends AbstractArpConf<HDFSConf> {
  private static final String ARP_FILENAME = "arp/implementation/hdfs-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.hdfs.HDFSDriver";
